...
--
-- Host: localhost
-- Generation Time: Jan 15, 2014 at 08:31 AM
...
(18, 3, 42, 'So, if I have an answer, I try the wikipedia spellings. Would that be fine? Or should I also try possible other spellings?', 0, 1389810544),
...
(4, 2, 0, 'Kushal Singh', 'kushal', 'Singh', 1389810615, 0),
...
(10, 1, 0, 'AAKASH ANUJ', 'aakashanuj', 'ANUJ', 1389807019, 0),
...
(15, 1, 0, 'Chinmay Agrawal', 'chin2', 'Agrawal', 1389807036, 0),
...
(38, 1, 0, 'klaus klaus', 'drogenbob', 'klaus', 1389807215, 0),
...
(54, 1, 0, 'Pulkit Agarwal', 'Timehacker', 'Agarwal', 1389807311, 0),
(55, 1, 0, 'Palash Mittal', 'TheManiac', 'Mittal', 1389807315, 0),
(56, 1, 0, 'rahul anand', '300', 'anand', 1389807340, 0),
(57, 1, 0, 'ashish singh', 'ashish', 'singh', 1389807348, 0),
(58, 2, 0, 'papireddygari maneesha', 'immad', 'maneesha', 1389810349, 0),
...
(63, 1, 0, 'Andrey Kashin', 'acid', 'Kashin', 1389807385, 0),
...
(79, 1, 0, 'Yogeesh S', 'y0g1337h', 'S', 1389807863, 0),
...
(86, 1, 0, 'Nishant Prateek', 'IT', 'Prateek', 1389808016, 0),
...
(98, 1, 0, 'Ashish Sahay', 'phire404', 'Sahay', 1389808342, 0),
(99, 3, 0, 'Sriram Narayanan', 'Sriram', 'Narayanan', 1389809741, 0),
(100, 1, 0, 'Carl Johnson', 'carlj', 'Johnson', 1389808391, 0),
...
(113, 1, 0, 'ravindar kumar', 'root', 'kumar', 1389808698, 0),
...
(131, 2, 0, 'Sharan Girdhani', 'sharan123', 'Girdhani', 1389809631, 0),
...
(139, 1, 0, 'Sudharshan Kumar', 'draco', 'Kumar', 1389809630, 0),
...
(144, 2, 0, 'Prachish Gora', 'drazen167', 'Gora', 1389810712, 0),
...
(153, 1, 0, 'abba papa', 'DAddY', 'papa', 1389810150, 0),
...
(170, 1, 0, 'Praveen Dakwale', 'praveend', 'Dakwale', 1389810656, 0),
