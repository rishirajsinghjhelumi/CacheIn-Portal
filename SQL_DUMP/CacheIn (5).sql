...
--
-- Host: localhost
-- Generation Time: Jan 15, 2014 at 10:59 AM
...
(1, 3, 0, 'Admin User', 'Admin', 'User', 1389814358, 0),
...
(12, 2, 0, 'Luap Notnevets', 'HENLEYbls', 'Notnevets', 1389814004, 0),
(13, 8, 0, 'Sambuddha Basu', 'sambuddhabasu', 'Basu', 1389819079, 0),
...
(24, 8, 0, 'Amogh Pradeep', 'amoghbl1', 'Pradeep', 1389819111, 0),
...
(29, 4, 0, 'Ada Lovelace', 'MaliceInWonderland', 'Lovelace', 1389819257, 0),
(30, 3, 0, 'Rashi Shrishrimal', 'ras20', 'Shrishrimal', 1389811740, 0),
(31, 3, 0, 'NareshChowdary Kommuri', 'knc', 'Kommuri', 1389811867, 0),
...
(46, 12, 0, 'madhuri gaddam', 'devils', 'gaddam', 1389818328, 0),
...
(54, 7, 0, 'Pulkit Agarwal', 'Timehacker', 'Agarwal', 1389817184, 0),
...
(65, 12, 0, 'Pushyami Rachapudi', 'Push', 'Rachapudi', 1389818250, 0),
(66, 6, 0, 'crazy orangutan', 'crazyorangutan', 'orangutan', 1389816965, 0),
...
(83, 3, 0, 'Roopal Nahar', 'roop08', 'Nahar', 1389811897, 0),
...
(94, 5, 0, 'parag gupta', 'darkhorcrux', 'gupta', 1389812549, 0),
...
(102, 8, 0, 'Dinesh Singla', 'roxkiller', 'Singla', 1389817338, 0),
(103, 5, 0, 'Prateek Saxena', 'Pammi', 'Saxena', 1389813855, 0),
...
(108, 3, 0, 'Adarsh Mohata', 'adi', 'Mohata', 1389816812, 0),
...
(129, 5, 0, 'Tanmay Sahay', 'tanmaysahay94', 'Sahay', 1389818358, 0),
(130, 3, 0, 'Miles Bench', 'coffeeblack198', 'Bench', 1389810224, 0),
(131, 5, 0, 'Sharan Girdhani', 'sharan123', 'Girdhani', 1389814682, 0),
...
(169, 5, 0, 'Ajit Mathew', 'tija', 'Mathew', 1389819129, 0),
...
(190, 6, 0, 'RRR RRR', 'RRR', 'RRR', 1389815190, 0),
...
(203, 8, 0, 'Apurva Kumar', 'cruxeon', 'Kumar', 1389817232, 0),
...
(212, 4, 0, 'first last', 'ninja', 'last', 1389814462, 0),
(213, 12, 0, 'madhuri gaddam', 'LOL', 'gaddam', 1389818258, 0),
(214, 1, 0, 'priyanka deshpande', 'cashin', 'deshpande', 1389812344, 0),
(215, 8, 0, 'Vinil Narang', 'TheGame', 'Narang', 1389817058, 0),
...
(221, 5, 0, 'Pratik Jacob', 'pratikej', 'Jacob', 1389814403, 0),
...
(228, 5, 0, 'Saksham Garg', 'aiccha', 'Garg', 1389817214, 0),
...
(237, 6, 0, 'Jagannadharaju Dantuluri', 'rockthehell', 'Dantuluri', 1389819279, 0),
(238, 1, 0, 'SHUBHAM GARG', 'codeshubh', 'GARG', 1389815834, 0),
(239, 3, 0, 'Shounak Dey', 'dylandey', 'Dey', 1389819313, 0),
...
(244, 6, 0, 'Abhishek Chinni', 'Laxus94', 'Chinni', 1389819305, 0),
...
(248, 1, 0, 'IIITHyderabad Rocks', 'IIIT', 'Rocks', 1389817280, 0),
(249, 3, 0, 'Mallipeddi Hardhik', 'Hardy', 'Hardhik', 1389817551, 0),
(250, 1, 0, 'Rounak Patni', 'rounak1160', 'Patni', 1389817351, 0),
(251, 1, 0, 'Jyothiram Pekala', 'J0rd3n', 'Pekala', 1389817441, 0),
(252, 1, 0, 'Siddharth Son_of_Gora Bonda ;) ', 'perplex', 'gora', 1389817549, 0),
(253, 2, 0, 'harish chava', 'harish', 'chava', 1389819130, 0),
(254, 1, 0, 'Kshitij Kansal', 'kansal', 'Kansal', 1389817640, 0),
(255, 2, 0, 'Edward Kenway', 'Assassin', 'Kenway', 1389818158, 0),
...
(262, 3, 0, 'Sharvil Katariya', 'Sash', 'Katariya', 1389818976, 0),
(263, 1, 0, 'AKSHAY BAPAT', 'hawkeye', 'BAPAT', 1389818793, 0),
(264, 2, 0, 'Jack Baurer', '24', 'Baurer', 1389819307, 0),
(265, 3, 0, 'Akshat Khandelwal', 'akshatk7', 'Khandelwal', 1389819476, 0),
(266, 1, 0, 'Pulkit Singhal', 'GodDamnit', 'Singhal', 1389818917, 0),
